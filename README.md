...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-26 22:14`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/dcefbc4f-2329-403a-b4a5-ec443a829d64.git
$ cd dcefbc4f-2329-403a-b4a5-ec443a829d64
```
